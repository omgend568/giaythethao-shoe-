            ...
            html: `
                <div style="max-width: 500px; margin: auto; font-family: Arial, sans-serif; background: #f9f9f9; padding: 20px; border-radius: 10px; border: 1px solid #ddd;">
                    <div style="background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0px 2px 10px rgba(0,0,0,0.1);">
                        ...
                        <p style="color: #555; font-size: 14px;">Mã OTP có hiệu lực trong 15 phút.</p>
                        <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
                        <p style="color: #555; font-size: 14px;">Hoặc click nút bên dưới để đặt lại mật khẩu:</p>
                        <div style="text-align: center; margin: 20px 0;">
                            <a href="${resetLink}" style="display: inline-block; background: #007bff; color: #fff; text-decoration: none; padding: 12px 30px; border-radius: 5px; font-size: 16px;">Đặt lại mật khẩu</a>
                        </div>
                        <p style="color: #999; font-size: 12px; word-break: break-all;">Hoặc copy link này vào trình duyệt:<br/>${resetLink}</p>
